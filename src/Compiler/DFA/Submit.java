...
public class Submit {
  ...
  public void submit(Integer partId) {
     ...
     * Test on Sample
     */
    String sampleoutput=new epsnfa().Start("E:/PRO/Java/HTest/src/Compiler/DFA/sampleRE.in");
    //String sampleoutput=new epsnfa().Start("E:/PRO/Java/HTest/src/Compiler/DFA/testRE.in");
  ...
  private String challenge_url() {
    return "http://www.coursera.org/automata/assignment/challenge";
  }

  private String submit_url() {
    return "http://www.coursera.org/automata/assignment/submit";
  }
